...
<body>
    ...
    <section class="section-doctors-preview section-content">
    	<div class="container">
    		<div class="row">
    			<small class="section-doctors-preview-subtitle">Click our pictures to learn more about us or scroll down.</small>
    			<legend></legend>
    			<div class="doctor-preview-img-one doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Robert L. Daschbach</p>
    			</div>
    			<div class="doctor-preview-img-two doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Marie E. Groncki</p>
    			</div>
    			<div class="doctor-preview-img-three doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Maq A. Serang</p>
    			</div>
    			<div class="doctor-preview-img-four doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Scott A. Gradwell</p>
    			</div>
    			<div class="doctor-preview-img-five doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Paul J. Adams</p>
    			</div>
    			<div class="doctor-preview-img-six doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6">
    				<div class="doctor-preview-img-overlay"></div>
    				<p class="doctor-preview-img-title">Sarah R. Woolcock</p>
    			</div>
    		</div>
    	</div>
    </section>
    ...
    <section class="section-about section-content section-doctor-one">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="doctor-bio-header">Robert L. Daschbach, D.D.S.</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        ...
                        <h3 class="doctor-bio-header">Today</h3>
    ...
    <section class="section-about-alt section-content section-doctor-two">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="doctor-bio-header-alt">Marie E. Groncki, D.M.D.</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
    ...
    <script>
        ...
        $(".doctor-preview-img").mouseenter(function(){
        	$(this).children("div").addClass("hover-class");
        	$(this).children("p").addClass("hover-class-title");
        });

        $(".doctor-preview-img").mouseleave(function(){
        	$(this).children("div").removeClass("hover-class");
        	$(this).children("p").removeClass("hover-class-title");
        });

        $(".doctor-preview-img").click(function(){
        	var eleClass = $(this).attr("class");
        	eleClass = eleClass.replace("doctor-preview-img col-lg-4 col-md-4 col-sm-6 col-xs-6", "");
        	eleClass = eleClass.replace("doctor-preview-img", "");
			$('html, body').stop().animate({
				'scrollTop': $(".section-doctor" + eleClass).offset().top+2
			}, 700, 'swing', function () {
			});
        });
